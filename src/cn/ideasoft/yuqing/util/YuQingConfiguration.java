...
package cn.ideasoft.yuqing.util;
 ...
 * resources.  */
public class YuQingConfiguration {
  
  private final static String KEY = YuQingConfiguration.class.getName();
  
  private YuQingConfiguration() {}                 // singleton

  // for back-compatibility, add old aliases for these Writable classes
  // this may be removed after the 0.8 release
  static {
    WritableName.addName(cn.ideasoft.yuqing.fetcher.FetcherOutput.class,"FetcherOutput"); 
    WritableName.addName(cn.ideasoft.yuqing.parse.ParseData.class, "ParseData"); 
    WritableName.addName(cn.ideasoft.yuqing.parse.ParseText.class, "ParseText"); 
    WritableName.addName(cn.ideasoft.yuqing.protocol.Content.class, "Content");
  }
  ...
  public static Configuration addNutchResources(Configuration conf) {
    conf.addDefaultResource("yuqing-default.xml");
    conf.addFinalResource("yuqing-site.xml");
    return conf;
  }
