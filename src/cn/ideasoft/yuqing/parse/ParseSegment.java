...
public class ParseSegment extends Configured implements Mapper, Reducer {
  ...
  public void map(WritableComparable key, Writable value,
    ...
    if (parse != null) {
      ...
      parse.getData().getContentMeta().set(YuQing.SEGMENT_NAME_KEY, getConf().get(YuQing.SEGMENT_NAME_KEY));
    }
  ...
  public static void main(String[] args) throws Exception {
    ...
    ParseSegment parseSegment = new ParseSegment(YuQingConfiguration.create());
