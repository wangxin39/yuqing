...
public class DistributedSearch {
  ...
  public static class Server  {
    ...
    static org.apache.hadoop.ipc.Server getServer(Configuration conf, Path directory, int port) throws IOException{
      YuQingBean bean = new YuQingBean(conf, directory);
  ...
  public static class Client extends Thread
    ...
    public static void main(String[] args) throws Exception {
      ...
      Query query = Query.parse(args[0], YuQingConfiguration.create());
      ...
      Client client = new Client(addresses, YuQingConfiguration.create());
