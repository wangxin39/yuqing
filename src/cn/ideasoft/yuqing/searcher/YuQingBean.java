...
import cn.ideasoft.yuqing.indexer.*;
...
public class YuQingBean
  ...
  public static final Log LOG = LogFactory.getLog(YuQingBean.class);
...
//  }
  ...
  public static YuQingBean get(ServletContext app, Configuration conf) throws IOException {
    YuQingBean bean = (YuQingBean)app.getAttribute("nutchBean");
    if (bean == null) {
      if (LOG.isInfoEnabled()) { LOG.info("creating new bean"); }
      bean = new YuQingBean(conf);
   ...
   * @throws IOException
   */
  public YuQingBean(Configuration conf) throws IOException {
    this(conf, null);
  }
   ...
   * @throws IOException
   */
  public YuQingBean(Configuration conf, Path dir) throws IOException {
        this.conf = conf;
  ...
  public static void main(String[] args) throws Exception {
    ...
    YuQingBean bean = new YuQingBean(conf);
