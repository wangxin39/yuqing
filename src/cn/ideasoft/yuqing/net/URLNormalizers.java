 ...
 * <code>cn.ideasoft.yuqing.net.urlnormalizer.pass.PassURLNormalizer</code> should be used.</p>
...
public final class URLNormalizers {
  ...
  /** Scope used by {@link cn.ideasoft.yuqing.crawl.PartitionUrlByHost}. */
  public static final String SCOPE_PARTITION = "partition";
  /** Scope used by {@link cn.ideasoft.yuqing.crawl.Generator}. */
  public static final String SCOPE_GENERATE_HOST_COUNT = "generate_host_count";
  /** Scope used by {@link cn.ideasoft.yuqing.fetcher.Fetcher} when processing
   * redirect URLs.
   */
  ...
  /** Scope used by {@link cn.ideasoft.yuqing.crawl.Injector}. */
  public static final String SCOPE_INJECT = "inject";
  /** Scope used when constructing new {@link cn.ideasoft.yuqing.parse.Outlink} instances. */
