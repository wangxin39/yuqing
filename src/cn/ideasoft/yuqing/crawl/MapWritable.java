...
import cn.ideasoft.yuqing.protocol.ProtocolStatus;
...
public class MapWritable implements Writable {
  ...
  static {
    ...
    addToMap(cn.ideasoft.yuqing.fetcher.FetcherOutput.class,
        new Byte((byte) -123));
    addToMap(cn.ideasoft.yuqing.protocol.Content.class, new Byte((byte) -122));
    addToMap(cn.ideasoft.yuqing.parse.ParseText.class, new Byte((byte) -121));
    addToMap(cn.ideasoft.yuqing.parse.ParseData.class, new Byte((byte) -120));
