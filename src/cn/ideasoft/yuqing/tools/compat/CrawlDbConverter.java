...
package cn.ideasoft.yuqing.tools.compat;
...
import cn.ideasoft.yuqing.crawl.MapWritable;
 ...
 * Optionally {@link cn.ideasoft.yuqing.crawl.CrawlDatum#metaData} can be converted
...
public class CrawlDbConverter extends ToolBase implements Mapper {
  ...
  public static void main(String[] args) throws Exception {
    int res = new CrawlDbConverter().doMain(YuQingConfiguration.create(), args);
  }
