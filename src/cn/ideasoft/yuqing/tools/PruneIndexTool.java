 ...
 * Analyzer on the final set of query terms. You can use {@link cn.ideasoft.yuqing.searcher.Query#main(String[])}
 ...
 * are created. To prevent this, use your own {@link cn.ideasoft.yuqing.net.URLFilter},
...
public class PruneIndexTool implements Runnable {
   ...
   * <p>NOTE: you may wish to use {@link cn.ideasoft.yuqing.searcher.Query#main(String[])}
