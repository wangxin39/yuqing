...
public class YuQingAnalysisTokenManager implements YuQingAnalysisConstants
{
  /** Constructs a token manager for the provided Reader. */
  public YuQingAnalysisTokenManager(Reader reader) {
...
public YuQingAnalysisTokenManager(CharStream stream){
   input_stream = stream;
}
public YuQingAnalysisTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
