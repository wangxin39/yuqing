 ...
 * analyzer {@link YuQingDocumentTokenizer}, with no stop list. This keeps it
 * consistent with query parsing.
 */
public class YuQingDocumentAnalyzer extends YuQingAnalyzer {
   ...
   * @param conf
   */
  public YuQingDocumentAnalyzer(Configuration conf) {
    this.conf = conf;
  ...
  private static class ContentAnalyzer extends Analyzer {
    ...
    /** Constructs a {@link YuQingDocumentTokenizer}. */
    public TokenStream tokenStream(String field, Reader reader) {
      return this.commonGrams.getFilter(new YuQingDocumentTokenizer(reader),
          field);
    }
  }
