...
package cn.ideasoft.yuqing.servlet;

import cn.ideasoft.yuqing.metadata.Metadata;
import cn.ideasoft.yuqing.net.protocols.Response;
import cn.ideasoft.yuqing.searcher.YuQingBean;
import cn.ideasoft.yuqing.searcher.Hit;
import cn.ideasoft.yuqing.searcher.HitDetails;
...
public class Cached extends HttpServlet {
  ...
  YuQingBean bean = null;

  public void init() {
    init(YuQingConfiguration.create());
  }
  
  public void init(Configuration conf) {
    try {
      bean = YuQingBean.get(this.getServletContext(), conf);
    } catch (IOException e) {
      // nothing
    }
  }
